  ...
  <div class="svg_icon">
    ...
    <div class="svg_aggregate" ref="svgAggregate">
      <svg xmlns="http://www.w3.org/2000/svg">
        ...
        <symbol id="icon-color">
          <path d="M47.425641 0H559.425641V512H47.425641z" fill="#1FD1B5" p-id="4280"></path>
          <path d="M559.425641 0h512V512H559.425641z" fill="#FFD400" p-id="4281"></path>
          <path d="M47.425641 512H559.425641v512H47.425641z" fill="#00A2FD" p-id="4282"></path>
          <path d="M559.425641 512h512v512H559.425641z" fill="#FF6663" p-id="4283"></path>
        </symbol>
      </svg>
    </div>
  </div>
